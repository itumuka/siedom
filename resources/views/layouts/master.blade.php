...
<head>
    ...
    <meta name="description" content="Universitas Muhammadiyah Karanganyar">
    <meta name="author" content="IT UMUKA">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <link rel="icon" href="{{ URL::asset('images/logo.png') }}">
    <meta property="og:site_name" content="UMUKA">
    <meta property="og:title" content="{{ isset($title)?$title:'Universitas Muhammadiyah Karanganyar' }}">
    <meta property="og:description" content="{{isset($description)?$description:'Universitas Muhammadiyah Karanganyar'}}">
    <meta property="og:type" content="website">
    <meta property="og:locale" content="en">
    <meta property="og:url" content="https://umuka.ac.id/">
    <meta property="og:image" content="{{ isset($gambar) ? URL::asset('images/' . $gambar . '') : URL::asset('images/logo.png') }}">
    <meta property="og:image:width" content="640">
    <meta property="og:image:height" content="480">
    <meta property="og:image:alt" content="{{ isset($title)?$title:'Universitas Muhammadiyah Karanganyar' }}">

    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:site" content="@wakhid_21">
    <meta name="twitter:creator" content="@wakhid_21">
    <meta name="twitter:title" content="{{ isset($title)?$title:'Universitas Muhammadiyah Karanganyar' }}">
            ...
            <ul class="menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="{{ Route::is('fakultas_show') ? 'active' : '' }}"><a
                                href="{{ route('fakultas_show') }}">Fakultas</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="widget widget_gallery clearfix">
                            ...
                            <hr class="bg-primary mb-10 mt-0 d-inline-block mx-auto w-60">
                            <ul class="list-unstyled" id="data_gambar"></ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-12">
                        <div class="widget">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 col-12 text-md-start text-center"> <span class="text-white">All Rights
                            Reserved. © 2023 Universitas Muhammadiyah Karanganyar</span></div>
