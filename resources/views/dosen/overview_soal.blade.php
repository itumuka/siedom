...
<div class="soal-wrapper">
    ...
    <div class="action-bar">
        <div>
            <a href="{{ url('/dosen/kelas/detail/'.$id_kelas) }}" class="btn btn-outline-secondary btn-sm">
                <i class="fa fa-arrow-left mr-1"></i> Kembali ke Detail Kelas
            </a>
            <a href="{{ url('/dosen/kelas') }}" class="btn btn-outline-secondary btn-sm ml-1">
                <i class="fa fa-list mr-1"></i> Daftar Kelas Saya
            </a>
        </div>
        <div>
...
$(function(){
    ...
    $.getJSON("{{ url('/dosen/kelas/'.$id_kelas.'/soal/data') }}", function(res){
