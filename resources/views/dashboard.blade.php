    ...
    columns: [
                    {
                        ...
                        render: function(data, type, row, meta) {
                            return '<button type="button" class="btn btn-sm btn-primary btn-detail" data-id_kelas="' + row.id_kelas + '">Detail</button>';
                        }
                    },
                    {
            ...
            $(document).on('click', '.btn-detail', function(event) {
                ...
                // Store the selected ID and all data in local storage
